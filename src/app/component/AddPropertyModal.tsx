            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-blue-700">
                  Upload your property registration or sale deed for
                  verification. Digitally signed documents provide enhanced
                  security and can be used for zero-knowledge proofs.
                </p>
              </div>
            </div>
          </div>
