      ...
      <main className="container mx-auto px-6 py-16">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-600 mb-8 leading-relaxed">
            Connect directly with property owners. List your property or find
            your dream home. No middleman, no extra fees. Secure verification
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-20">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600">
              No broker commissions, no hidden charges. Direct connection
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600">
              Property documents verified using zero-knowledge proofs.
              Cryptographic security without revealing sensitive data.
            </p>
          </div>
        </div>
