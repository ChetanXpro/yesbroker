...
struct PropertyProofFixtureJson {
...
contract CertificateVerifierGroth16Test is Test {
    ...
    function test_ValidGSTProof() public view {
        ...
        assert(certificateVerifier.verifier() == verifier);
        assert(
            certificateVerifier.gstProgramVKey() ==
                bytes32(
        ...
        assert(certificateVerifier.isDocumentVerified(testDocCommitment) == false);
        assert(certificateVerifier.isPublicKeyVerified(testPublicKeyHash) == false);
    }
    ...
    function testRevert_InvalidGSTProof() public {
        ...
        certificateVerifier.verifyGSTProof(mockPublicValues, mockProof);
    }
}
